...
// Function to find all N-digit binary numbers with equal sum of
// first and second half bits in Bottom-up manner
...
// Find all N-digit binary numbers with equal sum of left and right half
int main()
{
	int n = 6;		// N-digit
